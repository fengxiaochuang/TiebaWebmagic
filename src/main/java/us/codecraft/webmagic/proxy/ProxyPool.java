...
public class ProxyPool {
    ...
    */
    ...
    private void setFilePath() {
        ...
        String path = tmpDir + FilePersistentBase.PATH_SEPERATOR + "us/codecraft/webmagic" + FilePersistentBase.PATH_SEPERATOR + "lastUse.proxy";
        if (tmpDir != null && new File(tmpDir).isDirectory()) {
            fBase.setPath(tmpDir + FilePersistentBase.PATH_SEPERATOR + "us/codecraft/webmagic");
    ...
    public void returnProxy(HttpHost host, int statusCode) {
        ...
        if (p.getFailedNum() > 0 && p.getFailedNum() % 5 == 0) {
        	System.out.println("failed num" + p.getFailedNum());
