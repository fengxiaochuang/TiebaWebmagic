...
public class Site {
     ...
     * @return new site
     */
    public static us.codecraft.webmagic.Site me() {
        return new us.codecraft.webmagic.Site();
    }
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site addCookie(String name, String value) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site addCookie(String domain, String name, String value) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setUserAgent(String userAgent) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setDomain(String domain) {
        this.domain = domain;
        return this;
    }
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setCharset(String charset) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setTimeOut(int timeOut) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setAcceptStatCode(Set<Integer> acceptStatCode) {
     ...
     * @deprecated
     */
    public us.codecraft.webmagic.Site addStartUrl(String startUrl) {
     ...
     * @deprecated
     */
    public us.codecraft.webmagic.Site addStartRequest(Request startRequest) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setSleepTime(int sleepTime) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site addHeader(String key, String value) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setRetryTimes(int retryTimes) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setCycleRetryTimes(int cycleRetryTimes) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setHttpProxy(HttpHost httpProxy) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setRetrySleepTime(int retrySleepTime) {
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setUseGzip(boolean useGzip) {
    ...
    public Task toTask() {
        return new Task() {
            ...
            public String getUUID() {
                return us.codecraft.webmagic.Site.this.getDomain();
            }

            @Override
            public us.codecraft.webmagic.Site getSite() {
                return us.codecraft.webmagic.Site.this;
            }
        };
    }
    ...
    public boolean equals(Object o) {
        ...
        us.codecraft.webmagic.Site site = (us.codecraft.webmagic.Site) o;
     ...
     * @return this
     */
    public us.codecraft.webmagic.Site setHttpProxyPool(List<String[]> httpProxyList) {
        this.httpProxyPool=new ProxyPool(httpProxyList);
        return this;
    }

    public us.codecraft.webmagic.Site enableHttpProxyPool() {
    ...
    public us.codecraft.webmagic.Site setProxyReuseInterval(int reuseInterval) {
