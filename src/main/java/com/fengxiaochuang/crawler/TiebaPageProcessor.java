package com.fengxiaochuang.crawler;

import com.fengxiaochuang.crawler.extension.PrintPipeline;
 ...
 * @version 创建时间：2016年3月9日 上午11:58:52 类说明:
 */
public class TiebaPageProcessor implements PageProcessor {
    ...
    private Site site = Site.me().enableHttpProxyPool();
    ...
    public Site getSite() {
        ...
        // .setSleepTime(this.sleepTime).addCookie("tieba.baidu.com",
        // "TIEBAUID", "52dc7439f3e72559bb48a912")
        // .addCookie("tieba.baidu.com", "TIEBA_USERTYPE",
        // "fcf922b15b80e609daefdb56")
        ...
        // .addCookie("tieba.baidu.com", "fuwu_center_bubble",
        // "1").addCookie("tieba.baidu.com", "rpln_guide", "1")
    ...
    public static void main(String[] args) {
        ...
        // String startUrl =
        // "http://tieba.baidu.com/f?kw=好歌&fr=home&fp=0&ie=utf-8";
        int siteId = 2;
        int sleepTime = 3000;
        int thread = 1;
        ...
        Spider spider = Spider.create(pageProcessor).addUrl(startUrl).setScheduler(new QueueScheduler())
                .addPipeline(new PrintPipeline()).thread(thread);
        spider.start();
    }
}
